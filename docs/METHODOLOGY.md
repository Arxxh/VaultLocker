...
- Marco de trabajo: ágil ligero (Scrum)
...
- Cuantitativo: métricas de errores, rendimiento, cobertura de tests, tiempos de respuesta y uso de memoria en la extensión/backend.
...
6. Verificación: pruebas unitarias/integración, revisión de permisos/CSP, validación de entornos y hardware.
7. Despliegue y observabilidad: builds firmadas, monitoreo de errores/performance, rotación de secretos.
...
- Seguridad: tiempo de parcheo, reducción de permisos.
